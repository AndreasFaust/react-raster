...
var getMediaQueries = (function (breakpoints) {
  ...
  return breakpoints.map(function (bp, index) {
    ...
    return function () {
      return styled.css(_templateObject(), bp, max, styled.css.apply(void 0, arguments));
    };
  });
});
...
var StyledInnerCustom = styled__default(StyledInner)(_templateObject3(), function (props) {
  return props.media.map(function (media, index) {
    return media(_templateObject4(), props.style[index]);
  });
});
var StyledInnerControl = styled__default('div')(_templateObject5(), function (props) {
...
var Inner = function Inner(_ref2) {
  ...
  return React__default.createElement(StyledInnerCustom, {
    className: className,
    media: media,
    alignX: alignX,
    alignY: alignY,
    style: style
  }, controlIsVisible ? React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledInnerControl, {
...
var StyledContainer = (function (props) {
  if (props.cssMode === 'flex') {
    return React__default.createElement(FlexContainer, props);
  }

  return React__default.createElement(GridContainer, props);
});
...
var FlexContainer$1 = styled__default(Container)(_templateObject4$2(), function (props) {
  return props.media.map(function (media, index) {
...
var StyledContainer$1 = (function (props) {
  if (props.cssMode === 'flex') {
    return React__default.createElement(FlexContainer$1, props);
  }

  return React__default.createElement(GridContainer$1, props);
});
...
var Box = function Box(_ref) {
  ...
  var leftNormalized = React.useMemo(function () {
    return normalizeProps({
      prop: left,
      breakpoints: breakpoints
    });
  }, [left, breakpoints]);
  var rightNormalized = React.useMemo(function () {
    return normalizeProps({
      prop: right,
      breakpoints: breakpoints
    });
  }, [right, breakpoints]);
  var topNormalized = React.useMemo(function () {
    return normalizeProps({
      prop: top,
      breakpoints: breakpoints
    });
  ...
  var colsNormalized = React.useMemo(function () {
    return normalizeProps({
      prop: cols,
      defaultProp: parent,
      breakpoints: breakpoints
  ...
  var styleOuterNormalized = React.useMemo(function () {
    return normalizeProps({
      prop: styleOuter,
      breakpoints: breakpoints
    });
  }, [styleOuter, breakpoints]);
  var styleInnerNormalized = React.useMemo(function () {
    return normalizeProps({
      prop: styleInner,
      breakpoints: breakpoints
    });
  }, [styleInner, breakpoints]);
  var styleNormalized = React.useMemo(function () {
...
var Grid = function Grid(props) {
  ...
  }, control && controlIsVisible && React__default.createElement(Control, {
    cssMode: cssModeNormalized,
    colspan: colspan,
    breakpoints: breakpoints,
    gutterX: gutterX,
