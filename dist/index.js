...
var ControlGrid = function (props) {
    ...
    return (React__default['default'].createElement(Box, { position: "absolute", className: "GridControl", colspan: colspan, columnGap: props.columnGap, autoRows: "100%", left: props.padding.left, right: props.padding.right, top: props.padding.top, bottom: props.padding.bottom }, __spreadArray([], Array(colspan[breakpoint.index])).map(function (_, index) { return (React__default['default'].createElement(Box, { key: index, display: "flex", alignSelf: "stretch", cols: 1, backgroundColor: props.controlColor || "rgba(0,0,0,0.12)" })); })));
};
...
var Box = React__default['default'].forwardRef(function (props, ref) {
    ...
    return (React__default['default'].createElement(StyledBox, __assign({}, propsNormalized, { id: id.current, tag: props.as, component: props.component, className: props.className ? ["Box", props.className].join(" ") : "Box", controlIsVisible: controlIsVisible, ref: boxRef, css: propsNormalized.css, attrs: __assign(__assign({}, undefinedProps), (props.innerHTML && {
