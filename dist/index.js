...
var GridContainer = React__default['default'].forwardRef(function (props, ref) {
...
function getElements(children, breakpoints, colsTotal) {
    ...
    return React__default['default'].Children.map(children, function (_a) {
...
var FlexContainer = styled__default['default'](Container)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  display: flex;\n  box-sizing: border-box;\n\n  ", "\n"], ["\n  display: flex;\n  box-sizing: border-box;\n\n  ",
    "\n"])), function (props) {
    return props.media.map(function (media, index) {
...
var BoxContainer = React__default['default'].forwardRef(function (props, ref) {
    switch (props.cssMode) {
        case "flex":
            return React__default['default'].createElement(FlexContainer, __assign({}, props, { ref: ref }));
        case "grid":
            return React__default['default'].createElement(GridContainer$1, __assign({}, props, { ref: ref }));
    }
});
...
var Box = React__default['default'].forwardRef(function (_a, ref) {
    ...
    var _u = React.useContext(Context), cssMode = _u.cssMode, breakpoints = _u.breakpoints, gutterX = _u.gutterX, gutterY = _u.gutterY, colspan = _u.colspan, parent = _u.parent, media = _u.media, controlIsVisible = _u.controlIsVisible, controlColor = _u.controlColor, register = _u.register;
    var _v = React.useState(undefined), hasChildBoxesRegistered = _v[0], setHasChildBoxes = _v[1];
...
var Grid = React__default['default'].forwardRef(function (_a, ref) {
    ...
    return (React__default['default'].createElement(GridContainer, { cssMode: cssModeNormalized, colspan: colspan, className: classnames([
            "Grid",
        ...
        control && controlIsVisible && (React__default['default'].createElement(ControlGrid, { cssMode: cssModeNormalized, colspan: colspan, breakpoints: breakpoints, gutterX: gutterX, gutterY: gutterY, left: left, right: right, top: top, bottom: bottom, controlColor: controlColor })),
